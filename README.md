...
|                  Rust (Serde Typed) |  0.102 |   111.62 + 12.02 |    4.29 |
|                 Rust (Serde Custom) |  0.108 |    111.35 + 0.00 |    4.45 |
...
|               D/ldc2 (Mir Asdf DOM) |  0.145 |   112.78 + 61.27 |    5.98 |
|                 C++/g++ (RapidJSON) |  0.168 |  113.23 + 122.23 |    7.01 |
|              Scala (jsoniter-scala) |  0.175 |   288.19 + 25.08 |    9.59 |
|             C++/clang++ (RapidJSON) |  0.230 |  112.41 + 128.97 |    9.57 |
|       D/ldc2 (Mir Amazon's Ion DOM) |  0.236 |   112.89 + 80.70 |    9.85 |
...
|                      C/clang (yajl) |  0.368 |    110.86 + 0.00 |   16.11 |
|                        C/gcc (yajl) |  0.371 |    110.87 + 0.00 |   15.98 |
|                                 Zig |  0.387 |   110.92 + 12.18 |   19.13 |
|                   Nim/clang (jsony) |  0.401 |   111.40 + 42.74 |   17.16 |
|                C++/g++ (Boost.JSON) |  0.401 |  113.30 + 435.95 |   16.68 |
|             C++/g++ (RapidJSON SAX) |  0.404 |    113.02 + 0.00 |   16.62 |
|                     Nim/gcc (jsony) |  0.408 |   111.08 + 42.77 |   17.46 |
...
|     C#/.NET Core (System.Text.Json) |  0.569 |  561.19 + 139.73 |   25.20 |
|                Rust (Serde Untyped) |  0.578 |  111.60 + 839.97 |   23.67 |
|         C++/clang++ (RapidJSON SAX) |  0.600 |    194.64 + 0.00 |   23.95 |
|                     Java (DSL-JSON) |  0.603 |  259.68 + 190.97 |   30.71 |
|                             V/clang |  0.631 |  111.45 + 496.21 |   26.92 |
|                               V/gcc |  0.637 |  111.44 + 496.21 |   26.60 |
|                      Crystal (Pull) |  0.655 |   113.07 + 18.41 |   28.93 |
|                    Crystal (Schema) |  0.676 |   113.04 + 48.84 |   29.69 |
|                         Python/pypy |  0.688 |  280.92 + 125.74 |   29.52 |
| C++/clang++ (RapidJSON SAX Precise) |  0.736 |    194.60 + 0.00 |   30.11 |
|                       Julia (JSON3) |  0.765 |  443.49 + 252.04 |   31.12 |
|             Perl (Cpanel::JSON::XS) |  0.778 |  125.51 + 402.87 |   32.36 |
|                                  Go |  0.856 |   117.05 + 79.91 |   34.96 |
|                                 PHP |  0.958 |  126.54 + 682.21 |   39.86 |
|                             Crystal |  0.966 |  113.04 + 392.50 |   41.41 |
|              Nim/clang (Packedjson) |  0.976 |  112.15 + 294.42 |   40.29 |
|                Nim/gcc (Packedjson) |  0.995 |  111.83 + 294.42 |   41.30 |
|                        C#/.NET Core |  1.063 |  569.35 + 295.46 |   47.16 |
|                    C++/g++ (json-c) |  1.176 | 113.39 + 1216.08 |   48.91 |
|                C++/clang++ (json-c) |  1.181 | 112.68 + 1216.08 |   49.16 |
|                             Clojure |  1.215 |  460.72 + 546.03 |   64.32 |
|                            Go/gccgo |  1.269 |   138.83 + 83.59 |   53.56 |
|              C++/clang++ (Nlohmann) |  1.272 |  112.52 + 360.17 |   54.07 |
|                             Nim/gcc |  1.336 |  111.83 + 919.88 |   55.94 |
|                           Nim/clang |  1.344 |  112.15 + 925.03 |   55.50 |
|                 CPython (UltraJSON) |  1.444 |  122.17 + 544.51 |   53.21 |
|                                Ruby |  1.449 |  123.97 + 263.13 |   60.95 |
|                        Ruby (--jit) |  1.449 |  380.63 + 263.24 |   61.11 |
|                  C++/g++ (Nlohmann) |  1.507 |  113.38 + 448.03 |   61.19 |
|                              Python |  1.525 |  120.25 + 375.17 |   59.36 |
|     F#/.NET Core (System.Text.Json) |  1.601 |  570.59 + 232.18 |   69.79 |
|                         Ruby (YAJL) |  1.965 |  123.81 + 282.68 |   82.27 |
|                              D/ldc2 |  2.082 |  112.86 + 680.20 |   86.06 |
|                             C#/Mono |  2.312 |   252.46 + 31.53 |   96.95 |
|                             Haskell |  2.539 |  116.59 + 697.45 |  107.60 |
|                           Rust (jq) |  2.640 |  113.50 + 778.25 |  110.56 |
|                          Ruby/jruby |  2.930 |  461.99 + 841.93 |  148.36 |
|    C++/clang++ (Boost.PropertyTree) |  3.166 | 194.88 + 1232.84 |  130.92 |
|        C++/g++ (Boost.PropertyTree) |  3.336 | 113.22 + 1440.12 |  139.30 |
|                            Vala/gcc |  3.613 |  114.79 + 940.47 |  154.92 |
|                          Vala/clang |  3.633 |  114.81 + 940.45 |  156.14 |
|                               D/gdc |  3.660 |  116.67 + 681.24 |  156.47 |
|                               D/dmd |  4.514 |  113.37 + 680.34 |  177.98 |
|                   Perl (JSON::Tiny) |  9.382 |  125.86 + 528.91 |  404.50 |
|            Ruby/truffleruby (--jvm) | 12.311 | 505.03 + 2467.82 |  747.19 |
|                    Ruby/truffleruby | 22.970 | 451.72 + 2314.87 | 1119.70 |
